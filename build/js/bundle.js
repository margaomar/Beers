...
var Beer = function () {
    //class 
    function Beer(name, description, image_url, abv, ibu, ph, tagline, ingredients) {
    ...
    _createClass(Beer, [{
        key: 'getColorClass',
        value: function getColorClass(ph) {
            //loop alert colour on the different beers ph values
        ...
        value: function getBeerData() {
            ...
            var phColor = this.getColorClass(this.ph);
        ...
        key: 'getBeerModal',
        value: function getBeerModal() {
            //pop up information

            var maltString = '';
            var hopsString = '';
            var yeastString = this.yeast;
            var malt = this.malt;
            var hops = this.hops;
...
var $beersWrap = (0, _jquery2.default)('.grid-container');
//Add active class when press on beers
(0, _jquery2.default)(".beers").on('click', function () {
    (0, _jquery2.default)(this).siblings().removeClass("active");
    (0, _jquery2.default)(this).addClass("active");
    beerHomeBeer(); //call the homepage
    (0, _jquery2.default)('.pagination').removeClass('hide');
    // add second menu again
    (0, _jquery2.default)('.main-menu').removeClass('hide');
    (0, _jquery2.default)('header').removeClass('hide-nav');
});
...
function beerHomeBeer() {
    ...
    _jquery2.default.ajax({
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            var beer = new Beer(data[i].name, data[i].description, data[i].image_url, data[i].abv, data[i].ibu, data[i].ph, data[i].tagline, data[i].ingredients);
            $beersWrap.append(beer.getBeerData());
            //add active class
            (0, _jquery2.default)('.beers').addClass("active");
        };
...
//Paginacion
(0, _jquery2.default)(".pag-number").on('click', "li", function () {
    //Paginacion
    (0, _jquery2.default)(this).siblings().removeClass("active");
    (0, _jquery2.default)(this).addClass("active");
    ...
    var page = (0, _jquery2.default)(this).text();
...
// Random
(0, _jquery2.default)('.quick-find').on('click', random); // Random call on click
function random() {
    //Quick find (Random) + modal, using getBeerDetData
    (0, _jquery2.default)(this).siblings().removeClass("active");
    (0, _jquery2.default)(this).addClass("active");
    //remove second menu and pag
    (0, _jquery2.default)('.main-menu').addClass('hide');
    (0, _jquery2.default)('header').addClass('hide-nav');
    (0, _jquery2.default)(".pagination").addClass("hide");
    ...
    _jquery2.default.ajax({
        ...
        var _loop = function _loop(i) {
            ...
            //getBeerModal()
            (0, _jquery2.default)('.btn-item-modal').on('click', function () {
                (0, _jquery2.default)('.section-detail').append(beer.getBeerModal());
                (0, _jquery2.default)('.modal-backdrop').addClass('show');
            });
            (0, _jquery2.default)('.grid-container').on('click', '.modal-closed', function () {
                (0, _jquery2.default)('.modal-container').addClass('hide');
                (0, _jquery2.default)('.modal-backdrop').removeClass('show');
            });
        };
...
(0, _jquery2.default)('.grid-container').on('click', ".btn-section-another", random); // Another beer random button call
(0, _jquery2.default)('.pick-beer').on('click', function () {
    // Pick a beer section
    (0, _jquery2.default)(this).siblings().removeClass("active");
    (0, _jquery2.default)(this).addClass("active");
